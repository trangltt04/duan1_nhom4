    ...
    <div class="container-content ">
        ...
        <div class="grid grid-cols-12 pt-12">
            <div class="px-3 xl:col-span-6 lg:col-span-6 md:col-span-7 sm:col-span-12 col-span-12">
                ...
                <div class="text-sm text-[#424242]">Hotline: 1900.999.099</div>
                <div class="text-sm text-[#424242]">
                    13 phố Trịnh Văn Bô, phường Phương Canh, quận Nam Từ Liêm, TP Hà Nội
                </div>

                <div class="text-sm text-[#424242] mt-2">Hotline: 1900.999.099</div>
        ...
        <div class="text-center text-sm leading-4 text-[#424242] pb-4">
            Bản quyền thuộc về nhóm 4 Fpoly
        </div>
    </div>
</footer>
...
document.addEventListener('click', function(event) {
    const isClickedInsideDropdown = dropdownButton.contains(event.target) || dropdownMenu.contains(event
        .target);
