...
<form class="max-w-sm mx-auto mt-9 " action="index.php?act=updateNxb" method="post">
    <div class="mb-5">
        ...
        <input type="text" id="disabled-input" aria-label="disabled input"
            ...
            value="<?php echo $Nxb['id'] ?>"  disabled>
    </div>
    <div class="mb-5">
        ...
        <input type="text"
         ...
         name="nameNxb" value="<?php echo $Nxb['name'] ?>">
    </div>
    <div class="flex items-center mb-5">
<!-- id -->
<input type="text" hidden value="<?php echo $Nxb['id'] ?>" name="id">
