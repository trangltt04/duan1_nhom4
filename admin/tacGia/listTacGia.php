<div class="relative overflow-x-auto">
    ...
    <div class="flex justify-between items-center mt-5">
        <form class="w-[500px]" action="index.php?act=listTacGia" method="post">
            <div class="relative ">
                <input type="search" id="search-dropdown"
                    ...
                    placeholder="Tìm kiếm danh mục..." name="searchTg" />
        ...
        <div class=""><a href="index.php?act=addTg"
                ...
                foreach ($listTg as $value) {               
                    echo '
                             <tr class="bg-white border-b px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                 ...
                                 <td class="px-6 py-4"><a href="index.php?act=editTg&id=' . $value['id'] . '"><input type="button" value="Sửa" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"></a> 
                                  <a href="index.php?act=deleteTg&id=' . $value['id'] . '" onclick="return confirm(\'Bạn muốn xóa ?\')"><input type="button" value="Xóa"  class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"></a></td>
                             </tr>
                                    ';
                }
            } else {
